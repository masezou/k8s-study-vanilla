...
if [ ${IMAGEDL} -eq 1 ]; then
	...
	ctr images pull --platform linux/${ARCH} docker.io/library/alpine:3.18.2
	ctr images tag docker.io/library/alpine:3.18.2 ${REGISTRY}/library/alpine:3.18.2
	ctr images push --platform linux/${ARCH} --plain-http ${REGISTRY}/library/alpine:3.18.2
	ctr images rm docker.io/library/alpine:3.18.2
	ctr images rm ${REGISTRY}/library/alpine:3.18.2
